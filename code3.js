...
const gooseQuote = [
    ...
    "Communicating, You know, the finger, I'm sorry. Excuse me.; Aw sh... I hate it when she does that.",
...
const ronQuote = [
    ...
    "Discovered by the Germans in 1904, they named it San Diego, which of course in German means a whale's vagina.", "You stay classy, San Diego.", "Let's go over the groundrules. Rule number 1: No touching of the hair or face... AND THAT'S IT!", `Ron Burgundy says "NO!"`];
...
const tyQuote = [
  "You take drugs, Danny?", "Don't sell yourself short Judge, you're a tremendous slouch.", "And all you have to do is get in touch with it, stop thinking, let things happen, and be the ball.", "I'm not quite sure where they are.", "Oh, Judge, I don't keep score."];

const spicoliQuote = [
  "No shirt, no shoes, No dice!", "Hey bud, let's party!", "If I'm here and you're here, doesn't that make it our time?", "Make up your mind, dude, is he gonna sh!t or is he gonna kill us?","I'm so wasted!", "You d!ck!"];

const bradQuote = [
  "Doesn't anyone f$#%ing knock any more?", "Get off my case, motherfucker!", "Mister, if you don't shut up I'm gonna kick one hundred percent of your ass!", "Learn it, Know it, Live it."];
